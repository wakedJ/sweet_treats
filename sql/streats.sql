...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Apr 04, 2025 at 10:15 AM
...
CREATE TABLE `delivery_rules` (
  `id` int(11) NOT NULL,
  `min_order_for_free_delivery` decimal(10,2) NOT NULL DEFAULT 50.00,
  `standard_delivery_fee` decimal(10,2) NOT NULL DEFAULT 5.00,
